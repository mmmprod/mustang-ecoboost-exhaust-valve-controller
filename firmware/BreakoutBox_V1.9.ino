 ...
 * - Watchdog 5s
 * 
 * PINOUT V1.9 (ESP32-C6 Touch LCD 1.9"):
...
// =============================================================================
// CONFIGURATION PINS V1.9 - ESP32-C6 Touch LCD 1.9"
// =============================================================================
...
void setup() {
    ...
    Serial.println("BreakoutBox V1.9 TACTILE");
...
void showResult() {
    if (g_pass) {
        ...
        else if (!g_press_ok) tft.print("CAPTEUR");
